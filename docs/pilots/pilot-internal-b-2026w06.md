...
- P0 fixes (owner/date): none
- P1 improvements (owner/date): simplify key trust-store provisioning / runtime-platform / 2026-03-15
- Claim changes needed (`ENFORCED`/`AUDITED`/`PLANNED`): none
